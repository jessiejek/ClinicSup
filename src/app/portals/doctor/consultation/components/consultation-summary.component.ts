...
@Component({
  ...
  template: `
    <div class="cs">
      ...
      <div class="cs-card cs-card--vitals">
      ...
      <div class="cs-card cs-card--rx" [class.cs-card--collapsed]="!rxExpanded" id="cs-rx">
        <div class="cs-card__accent"></div>
        <div class="cs-card__body">
          <div class="cs-card__header" (click)="rxExpanded = !rxExpanded">
            <h3 class="cs-card__title">
              ...
              Prescription
              <span class="cs-card__summary" *ngIf="!rxExpanded && prescriptionItems.length > 0">{{ prescriptionItems.length }} item{{ prescriptionItems.length !== 1 ? 's' : '' }}</span>
            </h3>
      ...
      <div class="cs-cols">
        <!-- Follow-Up -- collapsible (can grow) -->
        <div class="cs-card cs-card--fu" [class.cs-card--collapsed]="!fuExpanded">
          <div class="cs-card__accent"></div>
          <div class="cs-card__body">
            <div class="cs-card__header" (click)="fuExpanded = !fuExpanded">
              <h3 class="cs-card__title">
            ...
            <div class="cs-card__body-inner" *ngIf="fuExpanded">
  ...
  styles: [`
    ...
    .cs-card__body { flex: 1; min-width: 0; padding: var(--space-4) var(--space-5); }
    .cs-card__title { display: flex; align-items: center; gap: var(--space-2); margin: 0 0 var(--space-3); font-size: 0.95rem; font-weight: 700; color: #1e293b; letter-spacing: -0.01em; }
    ...
    .cs-card__header { display: flex; align-items: center; gap: var(--space-2); margin: calc(-1 * var(--space-4)) calc(-1 * var(--space-5)) var(--space-3); padding: var(--space-3) var(--space-5); cursor: pointer; user-select: none; border-bottom: 1px solid #f1f5f9; transition: background .12s; }
    .cs-card__header:hover { background: #f8fafc; }
    .cs-card__header .cs-card__title { margin-bottom: 0; }
    .cs-card__summary { font-size: 0.72rem; font-weight: 400; color: #94a3b8; margin-left: auto; }
    .cs-card__chevron { color: #94a3b8; flex-shrink: 0; transition: transform .2s; margin-left: auto; }
    ...
    .cs-empty { color: #94a3b8; font-style: italic; margin: 0; font-size: var(--text-sm); }
    ...
    /* Rx section needs id for scroll anchor */
    #cs-rx { scroll-margin-top: 16px; }
  `]
})
